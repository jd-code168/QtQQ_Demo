...
struct qt_meta_stringdata_ReceiveFile_t {
    QByteArrayData data[5];
    char stringdata0[62];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ReceiveFile_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ReceiveFile_t qt_meta_stringdata_ReceiveFile = {
    {
QT_MOC_LITERAL(0, 0, 11), // "ReceiveFile"
...
QT_MOC_LITERAL(4, 45, 16) // "on_okBtn_clicked"
    ...
    "ReceiveFile\0refuseFile\0\0on_cancelBtn_clicked\0"
    "on_okBtn_clicked"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_ReceiveFile[] = {
...
void ReceiveFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReceiveFile::refuseFile)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ReceiveFile::staticMetaObject = { {
    QMetaObject::SuperData::link<BasicWindow::staticMetaObject>(),
    qt_meta_stringdata_ReceiveFile.data,
    qt_meta_data_ReceiveFile,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ReceiveFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ReceiveFile.stringdata0))
