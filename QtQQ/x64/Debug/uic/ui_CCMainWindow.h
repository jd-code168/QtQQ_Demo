...
public:
    ...
    void setupUi(QWidget *CCMainWindowClass)
    {
        ...
        sizePolicy.setHeightForWidth(palcehold1->sizePolicy().hasHeightForWidth());
        palcehold1->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(placehold2->sizePolicy().hasHeightForWidth());
        placehold2->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(sysmin->sizePolicy().hasHeightForWidth());
        sysmin->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(sysclose->sizePolicy().hasHeightForWidth());
        sysclose->setSizePolicy(sizePolicy);
...
"font:75 12pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        ...
        sizePolicy.setHeightForWidth(stausBtn->sizePolicy().hasHeightForWidth());
        stausBtn->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(levelBtn->sizePolicy().hasHeightForWidth());
        levelBtn->setSizePolicy(sizePolicy);
        ...
        appWidget->setMaximumSize(QSize(16777214, 22));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 278, 468));
        ...
        sizePolicy.setHeightForWidth(bottomBtn_1->sizePolicy().hasHeightForWidth());
        bottomBtn_1->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(bottomBtn_2->sizePolicy().hasHeightForWidth());
        bottomBtn_2->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(bottomBtn_3->sizePolicy().hasHeightForWidth());
        bottomBtn_3->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(bottomBtn_4->sizePolicy().hasHeightForWidth());
        bottomBtn_4->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(bottomBtn_5->sizePolicy().hasHeightForWidth());
        bottomBtn_5->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(bottomBtn_6->sizePolicy().hasHeightForWidth());
        bottomBtn_6->setSizePolicy(sizePolicy);
        ...
        sizePolicy2.setHeightForWidth(bottomBtn_7->sizePolicy().hasHeightForWidth());
        bottomBtn_7->setSizePolicy(sizePolicy2);
    ...
    void retranslateUi(QWidget *CCMainWindowClass)
    {
        ...
        searchLineEdit->setPlaceholderText(QCoreApplication::translate("CCMainWindowClass", "\346\220\234\347\264\242\357\274\232\350\201\224\347\263\273\344\272\272\357\274\214\347\276\244", nullptr));
