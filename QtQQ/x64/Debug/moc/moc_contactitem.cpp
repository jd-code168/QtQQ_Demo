...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ContactItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ContactItem_t qt_meta_stringdata_ContactItem = {
    {
QT_MOC_LITERAL(0, 0, 11) // "ContactItem"
...
static const uint qt_meta_data_ContactItem[] = {
...
QT_INIT_METAOBJECT const QMetaObject ContactItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ContactItem.data,
